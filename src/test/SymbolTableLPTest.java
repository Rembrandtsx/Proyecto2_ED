...
public class SymbolTableLPTest extends TestCase
{

    private SymbolTableLP<Integer, String> hashTable;
    ...
    {
    	capacity=101;
        hashTable = new SymbolTableLP<>(capacity);
        size = 0;
    ...
    public void testPut( )
    {
        ...
        size=size+1;
        assertEquals( "La adici�n no se realiz� correctamente", hashTable.get(0), "Test 54" );
    ...
    */
    ...
    public void testReHash( )
    {
    	...
    	capacity=101;
        size = 52; ///Numero para el cual hay sobrecarga, se aplica rehash
        for( int cont = 0; cont < size; cont++ )
        {
            hashTable.put(cont, "Test " + cont);
        }
